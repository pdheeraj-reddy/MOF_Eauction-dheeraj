...
(function(n) {
    ...
    n.fn.hijriDatePicker.defaults = {
        ...
        disabledDates: !1,
        enabledDates: !1,
        icons: { time: "fa fa-clock text-normal", date: "glyphicon glyphicon-calendar", up: "fa fa-chevron-up text-normal", down: "fa fa-chevron-down text-normal", previous: "<<", next: ">>", today: "Ø§Ù„ÙŠÙˆÙ…", clear: "Ù…Ø³Ø­", close: "Ø§ØºÙ„Ø§Ù‚" },
