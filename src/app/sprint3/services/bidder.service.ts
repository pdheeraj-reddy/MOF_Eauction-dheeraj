...
export class BidderService {
  ...
  submitLiveBid(auctionId?: any, bidAmt?: any): Observable<any> {
    let bidDetails = {
      "AucId": auctionId,
      "BidderValue": bidAmt,
      "ZzUserAction": "B",
