...
@Component({
  selector: 'app-business-user-am-auction',
  templateUrl: './business-support-am-auction.component.html',
  styleUrls: ['./business-support-am-auction.component.scss']
})
export class BusinessSupportAmAuctionComponent implements OnInit {
  ...
  changeBiddingmethod(e: any, dd: string) {
    this.filterFormGroup.controls[dd].setValue(e.target.value, {
      onlySelf: true
    })
    this.getAuctionList(1);
