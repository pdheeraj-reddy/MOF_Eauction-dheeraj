...
@Component({
  selector: 'app-auc-mod-landing-page',
  templateUrl: './auc-mod-landing-page.component.html',
  styleUrls: ['./auc-mod-landing-page.component.scss'],
})
export class AucModLandingPageComponent implements OnInit, AfterViewInit {
  auctionListData: any;
