...
@Component({
  ...
  templateUrl: './auction-head-landing-page.component.html',
  styleUrls: ['./auction-head-landing-page.component.scss'],
})
export class AuctionHeadLandingPageComponent implements OnInit, AfterViewInit {
  auctionListData: any;
