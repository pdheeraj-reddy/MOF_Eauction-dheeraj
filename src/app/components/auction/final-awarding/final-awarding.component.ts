...
@Component({
  selector: 'app-final-awarding',
  templateUrl: './final-awarding.component.html',
  styleUrls: ['./final-awarding.component.scss']
})
export class FinalAwardingComponent implements OnInit {

  finalAwardingListData: any;
  ...
  getAuctionList(pageNumber?: number) {
    ...
    // });
    this.finalAwardingListData = this.mapping(res.body);
  }
}
