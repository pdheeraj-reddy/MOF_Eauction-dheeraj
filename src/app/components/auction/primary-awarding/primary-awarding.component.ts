...
@Component({
  selector: 'app-primary-awarding',
  templateUrl: './primary-awarding.component.html',
  styleUrls: ['./primary-awarding.component.scss']
})
export class PrimaryAwardingComponent implements OnInit {

  primaryAwardingListData: any;
  ...
  getAuctionList(pageNumber?: number) {
    ...
    // });
    this.primaryAwardingListData = this.mapping(res.body);
  }
}
