...
@Component({
  selector: 'app-disable-participation',
  templateUrl: './disable-participation.component.html',
  styleUrls: ['./disable-participation.component.scss']
})
export class DisableParticipationComponent implements OnInit {
  Amt: any;
  disableParticipatinListData: any;
  ...
  getAuctionList(pageNumber?: number) {
    ...
    // });
    this.disableParticipatinListData = this.mapping(res.body);
  }
  incAmt() {
    this.Amt++;
  }
