...
@Component({
  selector: 'app-primary-awarding-bidder',
  templateUrl: './primary-awarding-bidder.component.html',
  styleUrls: ['./primary-awarding-bidder.component.scss']
})
export class PrimaryAwardingBidderComponent implements OnInit {
  Amt: any;
  primaryAwardingBidderListData: any;
  ...
  getAuctionList(pageNumber?: number) {
    ...
    // });
    this.primaryAwardingBidderListData = this.mapping(res.body);
  }
}
